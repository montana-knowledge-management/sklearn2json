...
def serialize_gradient_boosting(model):
    ...
    serialized_model['estimators_'] = [serialize_decision_tree_regressor(regression_tree) for regression_tree
...
def serialize_random_forest(model):
    serialized_model = {
        ...
        'n_features_': model.n_features_,
        'n_features_in_': model.n_features_in_,
        # 'base_estimator_': serialize_decision_tree(model.base_estimator_),
        'n_outputs_': model.n_outputs_,
        'classes_': model.classes_.tolist(),
...
def deserialize_random_forest(model_dict):
    ...
    model.estimators_ = estimators  # np.array(estimators)
